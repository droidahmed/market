    ...
    private void retrieveData(){
        ...
        posts.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<CategoryModel> adapter = new ArrayAdapter<>(getActivity(),
...
//                }
    ...
    private void addData(){
        ...
        mDatabase.child("category").child("1").child("m1").child(edProductName.getText().toString()).setValue(productModel)
